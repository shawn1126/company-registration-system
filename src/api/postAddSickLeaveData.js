...
export function fetchData(_body) {
    ...
    const REQUERY_URL =
      "https://script.google.com/macros/s/AKfycbwhyqtNofMEJFmYvCdzW_sHQLGPlZNmCUPquZOa1ZOAOXK12jR8n1PxdF5d5Cf5RPzp/exec";
    const options = {
      method: "POST",
      headers: {
    ...
    return new Promise(function (resolve, reject) {
      fetch(REQUERY_URL, options)
        ...
        .then((responseData) => {
          // 使用者資訊寫入全域 redux
          console.log("test add sickleave data responseData", responseData);
