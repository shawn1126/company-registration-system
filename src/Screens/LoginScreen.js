...
import { StyleSheet, Text, View, Image, TextInput, TouchableOpacity, Modal ,useWindowDimensions} from 'react-native';
  ...
  return (
    <View style={[{ backgroundColor: nowBasicStyle.backgroundColor }, styles.container]}>
      ...
      <View style={[styles.Home_Logo, { backgroundColor: nowBasicStyle.backgroundColor, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }]}>
        <Text style={{ color: nowBasicStyle.fontColor, fontSize: 24,fontWeight:700}}>ZombieClub 打卡系統 ❤️</Text>
      </View>
      <Image
       style = {{width: 120, height: 120 }}
        source={{ uri: ('https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNWQ5czUzd2p1YjRvMzRwaWVheTZpMWswd215ZGx5YXpiN20zODJtdyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/hKAfPUuIvIu8rILnrs/giphy.gif') }}
      ></Image>
